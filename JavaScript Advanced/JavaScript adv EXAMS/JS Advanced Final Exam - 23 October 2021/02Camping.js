...
console.log(summerCamp.registerParticipant("gruicho", "student", 300));
console.log(summerCamp.timeToPlay("Battleship", "gruidcho"));
console.log(summerCamp.timeToPlay("WaterBalloonFights", "Petar Petarson", "gruicho"));
