...
describe('E2E tests', function () {
    ...
    describe('BONUS: Notifications [ 5 Points ]', () => {
        it.only('Login notification with invalid data', async () => {
            const endpoint = '**' + endpoints.login;
            let called = false;
            page.route(endpoint, route => called = true);
        ...
        it.only('Register notification with invalid data', async () => {
            const endpoint = '**' + endpoints.register;
            let called = false;
            page.route(endpoint, route => called = true);
        ...
        it.only('Edit notification with invalid data', async () => {
            // Login user
            const email = 'peter@abv.bg';
            const password = '123456';
            const longEndpoint = '**' + endpoints.login;
