...
namespace Tests
{
    public class ExtendedDatabaseTests
    {
        ...
        public void Add_ThrowsException_WhenUsernameIsUsed()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => this.extendedDatabase.Add(new Person(2, "Pesho")));
        }
        ...
        public void Add_ThrowsException_WhenIdIsUsed()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => this.extendedDatabase.Add(new Person(id, "Gosho")));
        }
        ...
        [Test]
        [TestCase("")] // tova tuka e vse edno string dolu username e "" a posle e null
        [TestCase(null)]
        ...
        [Test]
        public void FindByUsername_ThrowsException_WhenUsernameDoesntExist()
        {
        ...
        [TestCase(-1)]
        [TestCase(-25)]
        public void FindById_ThrowsException_WhenIdLessThenZero(long id)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => this.extendedDatabase.FindById(id));
        }

        [Test]
        public void FindById_ThrowsException_WhenUserWithIdDoesntExist()
        {
