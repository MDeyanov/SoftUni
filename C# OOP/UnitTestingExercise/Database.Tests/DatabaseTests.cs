...
namespace Tests
{
    public class DatabaseTests
    {
        ...
        [Test]
        public void Add_AddsEmelentToDataBase()
        {
            int element = 123;
        ...
        [Test]
        public void Remove_Should_DecreaseDatabaseCount()
        {
            this.database.Add(1);
            this.database.Add(2);
            this.database.Add(3);
        ...
        [Test]
        public void Remove_Should_RemoveElementFromDatabase()
        {
            this.database.Add(1);
            this.database.Add(2);
            this.database.Add(3);
        ...
        [Test]
        public void Count_ReturnZero_WhenDatabaseIsEmpty()
        {
