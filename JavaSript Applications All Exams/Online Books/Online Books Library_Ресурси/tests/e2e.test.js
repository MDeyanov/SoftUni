...
describe('E2E tests', function () {
    ...
    describe('BONUS : Like functionality  [ 15 Points ]', async () => {
        ...
        it.only('Like button is not visible for guest users [ 2.5 Points ]', async () => {
            const data = mockData.catalog[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('Like button is visible for the non-creator user [ 2.5 Points ]', async () => {
            // Login user
        ...
        it.only('Like button is not visible for the creator [ 2.5 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[0];
